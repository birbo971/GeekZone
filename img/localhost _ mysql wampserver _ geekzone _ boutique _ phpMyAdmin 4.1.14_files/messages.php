...
PMA_messages['strDeleteTrackingData'] = "Supprimer les données de suivi de cette table";
...
PMA_messages['strEnterValidNumber'] = "Veuillez entrer un nombre valide";
PMA_messages['strEnterValidLength'] = "Veuillez entrer une longueur valide";
PMA_messages['strAddIndex'] = "Ajouter Index";
...
PMA_messages['strAddUser'] = "Ajouter un utilisateur";
PMA_messages['strReloadingPrivileges'] = "Chargement des privilèges en cours";
...
PMA_messages['strRemoveChart'] = "Supprimer le graphique";
PMA_messages['strEditChart'] = "Éditer titre et étiquettes";
...
PMA_messages['setSetLongQueryTime'] = "Régler long_query_time à %ds";
...
PMA_messages['strChartEdit'] = "Modifier le graphique";
PMA_messages['strSeries'] = "Séries";
...
PMA_messages['strReloadDatabase'] = "Rafraîchir la base de données";
...
PMA_messages['strTableMustHaveAtleastOneColumn'] = "La table doit comporter au moins une colonne";
PMA_messages['strYes'] = "Oui";
PMA_messages['strNo'] = "Non";
PMA_messages['strInsertTable'] = "Insérer dans la table";
PMA_messages['strHideIndexes'] = "Cacher les index";
PMA_messages['strShowIndexes'] = "Montrer les index";
PMA_messages['strForeignKeyCheck'] = "Vérification des clés étrangères : ";
PMA_messages['strForeignKeyCheckEnabled'] = "(Activée)";
PMA_messages['strForeignKeyCheckDisabled'] = "(Désactivée)";
...
PMA_messages['strNoRowSelected'] = "Aucune ligne n\'a été sélectionnée";
PMA_messages['strChangeTbl'] = "Modifier";
PMA_messages['strQueryExecutionTime'] = "Durée d\'exécution de la requête";
...
PMA_messages['strZoomSearch'] = "Recherche par zoom";
...
PMA_messages['strQueryResults'] = "Opérations sur les résultats";
...
PMA_messages['strAddPolygon'] = "Ajouter un polygone";
PMA_messages['strAddColumns'] = "Ajouter des colonnes";
...
PMA_messages['strAddOption'] = "Ajouter une option pour la colonne ";
...
PMA_messages['strSortHint'] = "Cliquer pour trier";
...
PMA_messages['strShowDataRowLink'] = "Afficher les lignes correspondantes";
...
var mysql_doc_template = './url.php?url=http%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F5.5%2Fen%2F%25s.html&amp;server=0&amp;token=620f53bd31f8f67dc05beacf081e5cca';
if ($.datepicker) {
